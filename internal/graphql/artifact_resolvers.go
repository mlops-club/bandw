...
func (r *ArtifactResolver) Size() *Int64Scalar {
	...
	return &Int64Scalar{Value: r.artifact.Size}
}
...
func (r *ArtifactResolver) TtlDurationSeconds() *Int64Scalar {
	...
	return &Int64Scalar{Value: *r.artifact.TtlDurationSeconds}
}
...
func (r *ArtifactResolver) HistoryStep() *Int64Scalar {
	...
	return &Int64Scalar{Value: *r.artifact.HistoryStep}
}
...
func (r *FileResolver) SizeBytes() *Int64Scalar {
	...
	return &Int64Scalar{Value: *r.file.Size}
}
...
func (r *UploadUrlPartResolver) PartNumber() Int64Scalar { return Int64Scalar{} }
