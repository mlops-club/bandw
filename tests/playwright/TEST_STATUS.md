...
| Phase | Batch | Total | bandw |
|-------|-------|-------|-------|
| P0 | B1-B6 | 101 | **101** |
| P1 C1a | workspaces | ~30 | ~25 |
| P1 C1b | overview | 9 | **9** |
| P1 C1c | cascade | 35 | **31** |
| P1 C2+C3 | panels/runs | 95 | **95** |
| P2 D1-D4 | various | ~15 | ~few (SDK deps) |
| **Total** | | **~285** | **~261** |
...
- Infrastructure: File-based SDK caching, addInitScript auth
