...
test('filter by metric: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('filter by metric: Filter button opens filter controls', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
