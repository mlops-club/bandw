...
test('remove filter: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('remove filter: Filter button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
