...
test('default filters: table loads with runs', async ({ authedPage, targetConfig, sdkData }) => {
...
test('default filters: Filter button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
...
test('default filters: multiple runs are displayed in table', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
