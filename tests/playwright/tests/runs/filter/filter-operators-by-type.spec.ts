...
test('filter operators: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('filter operators: Filter button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
...
test('filter operators: table has metric columns', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
