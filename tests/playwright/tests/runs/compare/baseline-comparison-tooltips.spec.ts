...
test('baseline-comparison-tooltips: workspace loads with charts', async ({ authedPage, targetConfig, sdkData }) => {
...
test('baseline-comparison-tooltips: run names visible in workspace', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
  ...
  // Verify run names are visible in the workspace
