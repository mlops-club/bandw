...
test('manage columns move/pin: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('manage columns move/pin: Columns button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
