...
test('key-based coloring: workspace loads with charts', async ({ authedPage, targetConfig, sdkData }) => {
...
test('key-based coloring: workspace settings controls exist', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
