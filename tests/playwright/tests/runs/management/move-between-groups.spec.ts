...
test('move between groups: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('move between groups: Group button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
