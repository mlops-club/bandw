...
test('delete group: table loads with run data', async ({ authedPage, targetConfig, sdkData }) => {
...
test('delete group: Group button is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
