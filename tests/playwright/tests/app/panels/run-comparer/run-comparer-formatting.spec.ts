...
test('run-comparer-formatting: workspace loads with chart content', async ({ authedPage, targetConfig, sdkData }) => {
...
test('run-comparer-formatting: panel picker is accessible', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
...
test('run-comparer-formatting: workspace settings controls exist', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
