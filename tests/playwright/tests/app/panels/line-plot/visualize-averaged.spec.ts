...
test('visualize-averaged: workspace shows all training runs', async ({ authedPage, targetConfig, sdkData }) => {
...
test('visualize-averaged: workspace loads with Add panels button', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
