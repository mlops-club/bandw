...
test('data-settings: workspace loads with chart panels', async ({ authedPage, targetConfig, sdkData }) => {
...
test('data-settings: workspace settings button exists', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
