...
test('grouping-settings: workspace shows multiple runs', async ({ authedPage, targetConfig, sdkData }) => {
...
test('grouping-settings: chart panels visible for groupable metrics', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
