...
test('zoom: chart panels are visible and interactive', async ({ authedPage, targetConfig, sdkData }) => {
...
test('zoom: workspace loads with Add panels button', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
