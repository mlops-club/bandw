...
test('point-aggregation: chart panels render data points', async ({ authedPage, targetConfig, sdkData }) => {
...
test('point-aggregation: workspace loads with Add panels button', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
