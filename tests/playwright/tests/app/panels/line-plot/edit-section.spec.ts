...
test('edit-section: section headers visible in workspace', async ({ authedPage, targetConfig, sdkData }) => {
...
test('edit-section: workspace controls exist', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
  ...
  // Verify workspace-level controls exist (Add panels, settings, etc.)
