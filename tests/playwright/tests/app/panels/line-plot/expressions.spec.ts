...
test('expressions: chart panels render in workspace', async ({ authedPage, targetConfig, sdkData }) => {
...
test('expressions: workspace settings controls exist', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
