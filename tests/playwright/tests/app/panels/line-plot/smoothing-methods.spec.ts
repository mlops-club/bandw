...
test('smoothing-methods: workspace renders line charts', async ({ authedPage, targetConfig, sdkData }) => {
...
test('smoothing-methods: workspace settings controls exist', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
