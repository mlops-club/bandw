...
test('change-colors-table: run names visible in workspace sidebar', async ({ authedPage, targetConfig, sdkData }) => {
...
test('change-colors-table: workspace loads with Add panels button', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
