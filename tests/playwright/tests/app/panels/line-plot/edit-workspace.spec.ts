...
test('edit-workspace: workspace page loads with charts', async ({ authedPage, targetConfig, sdkData }) => {
...
test('edit-workspace: workspace has settings controls', async ({ authedPage, targetConfig, sdkData }) => {
  const page = authedPage;
  ...
  // Verify workspace-level controls exist (Add panels, section settings, etc.)
