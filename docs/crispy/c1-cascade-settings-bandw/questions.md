...
## Context
C1 cascade-settings has 35 tests that pass but 23 fail against bandw. All failures are because our workspace lacks settings panels (workspace-level, section-level, panel-level).

## Questions
1. What does the reference UI's "Workspace settings" panel look like? What elements does it expose?
